...
if __name__ == '__main__':
    ...
    # imgpath=r"./data/split/gt.png"
    imgpath = r"C:\Users\12082\Desktop\test\split_029_003.png"
    output_dir=r"C:\Users\12082\Desktop\test\re_029_003.png"

    img = cv2.imread(imgpath)
    print("开始执行...")
    img_msr = SSR(img, variance)
    print("MSR结束...")

    cv2.imwrite(output_dir, img_msr)
    # cv2.imwrite(output_dir+'/MSR.jpg', img_msr)
